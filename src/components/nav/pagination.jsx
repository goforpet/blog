...
export default class Pagination extends Component {
  render() {
    if (this.props.context.page && this.props.context.count > 1) {
      return (
        <nav className={classNames('pagination', 'is-centered')} role="navigation" aria-label="pagination">
  ...
  paginate() {
    ...
    for (let i = 0; i < count; i++) {
      ...
      if (page !== 1 && page !== count && page < context.current + 2 && page > context.current - 2) {
